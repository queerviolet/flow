...
// Should synchronous and asynchronous pipes have different precedence?
op_pipe
  = op_pipe_ltr / op_pipe_rtl
...
MultiLineComment
  = "/*" note:$(!"*/" ch:SourceCharacter { return ch; })* "*/" { return {note: note}; }

MultiLineCommentNoLineTerminator
  = "/*" note:$(!("*/" / LineTerminator) SourceCharacter)* "*/" { return {note: note}; }

SingleLineComment
  = "//" note:$(!LineTerminator ch:SourceCharacter { return ch; })* { return {note: note}; }
